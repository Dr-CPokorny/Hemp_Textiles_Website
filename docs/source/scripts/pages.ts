...
function build_body_for_learn(): string {
    ...
    const WHY_CARD_DURABLE = build_why_card_for_learn_page(
        ...
        "Coat made of hemp textiles used to show the durability factor behind hemp.",
    ...
    const WHY_CARD_BREATHABLE = build_why_card_for_learn_page(
        ...
        "Large white hemp quilt with star patterns weaved in.  Even though the quilt is large, it looks to be both light and soft.",
    ...
    const WHY_CARD_TEXTURED = build_why_card_for_learn_page(
        ...
        "Pieces of hemp fabric are displayed in different colors and put next to flowers and fungus to showcase its textural and color likeness to natural elements in the surrounding environment.",
    ...
    const WHY_CARD_BIODEGRADABLE = build_why_card_for_learn_page(
        ...
        "A bag made from hemp textiles that has been placed on a rock within a forest.  Possibly present to showcase that the bag could be left and biodegradation would take place?",
    ...
    const TEST_TEAR = build_material_test_for_learn_page(
        ...
        "A bar chart showing the differences between warp and weft tears of 4 different fabrics, the chart shows how much force it takes to cause a tear in a given direction.",
        "Tear Test Results",
    ...
    const TEST_ABRASION = build_material_test_for_learn_page(
        ...
        "A bar chart showing how many abrasion revolutions it took for 4 different fabrics to wear out.  The hemp/cotton blend took the longest to wear out.",
    ...
    const TEST_DRAPE = build_material_test_for_learn_page(
        ...
        "A bar chart showcasing 4 different fabrics and their average drape coefficients.  The hemp/cotton blend had the second highest, while the cotton fabric had the highest drape coefficient average.",
        "Drape Test Results",
    ...
    const TEST_SHRINKAGE = build_material_test_for_learn_page(
        ...
        "A bar chart showcasing 4 different fabrics and their average shrinkage in inches after being washed.  100% Cotton Kona had the least shrinkage (1st place), while the hemp/cotton blend had the 2nd highest shrinkage (3rd place).",
