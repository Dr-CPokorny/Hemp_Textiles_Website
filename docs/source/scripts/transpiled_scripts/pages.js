...
function build_body_for_home() {
    ...
    const CARD_MAKERS = build_card_for_home_page("\t\t\t\t", "assets/images/home_card_makers.svg", "Finished blue quilt made with hemp fabric.", "Made for Makers", "Quilters like you are leading the way to a greener future.");
    return [
...
function build_body_for_learn() {
    ...
    const WHY_CARD_TEXTURED = build_why_card_for_learn_page("\t\t\t\t", "assets/images/learn_why_card_textured.svg", "Text", "Naturally Textured and Tactile", "Its natural texture adds depth and character to quilts and textile work.");
