...
function build_body_for_learn() {
    ...
    // Why Card Information
    const WHY_CARD_DURABLE = build_why_card_for_learn_page("\t\t\t\t", "assets/images/learn_why_card_durable.svg", "Text", "Durable and Long-Lasting", "Hemp fibers are known for their strength and long-lasting quality.");
    const WHY_CARD_BREATHABLE = build_why_card_for_learn_page("\t\t\t\t", "assets/images/learn_why_card_breathable.svg", "Text", "Breathable and Lightweight", "Hemp fabric is breathable and gets softer with every wash and use; there is a limit to how soft it can get.");
    const WHY_CARD_TEXTURED = build_why_card_for_learn_page("\t\t\t\t", "assets/images/learn_why_card_textured.svg", "Text", "Naturally Textured and Tactile", "Its natural texture adds depth and character to textile work.");
    const WHY_CARD_BIODEGRADABLE = build_why_card_for_learn_page("\t\t\t\t", "assets/images/learn_why_card_biodegradable.svg", "Text", "Biodegradable and Lower-Impact", "Hemp requires less water and fewer pesticides than cotton.");
