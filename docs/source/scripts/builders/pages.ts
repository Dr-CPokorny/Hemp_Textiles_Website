...
function build_body_for_home(): string {
    return [
        ...
        `                   <img class="${SS.home_why_card_image}" src="assets/images/home_4.svg" alt="Finished patterned quilt made with hemp fabric.">`,
        ...
        ``,
        `               <div class="${SS.home_why_card_panel} ${SS.form_static_column_center}">`,
        `                   <img class="${SS.home_why_card_image}" src="assets/images/home_3.svg" alt="Finished white quilt made with hemp fabric.">`,
        ...
        ``,
        `               <div class="${SS.home_why_card_panel} ${SS.form_static_column_center}">`,
        `                   <img class="${SS.home_why_card_image}" src="assets/images/home_2.svg" alt="Finished blue quilt made with hemp fabric.">`,
...
function build_footer(): string {
    return [
        ...
        `               <a class="${SS.footer_link}" href="https://agsci.oregonstate.edu/hemp">Global Hemp Innovation Center</a>`,
